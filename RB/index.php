...
<div class="dashboard treb " style="background-color: rgba(0, 0, 0, 0.4);  opacity: inherit;">
	...
	<ul>
		<a href="index.php" ><li style="background: #141414; color: #ff6900;"><i class="fa fa-home fa-fw"></i> Home</li></a>
...
<div style="padding-top: 70px; padding-left: 270px" >
	<img src="photo/RB.png" height="95%" width="95%" />
</div>
</div>
</body>
</html>
